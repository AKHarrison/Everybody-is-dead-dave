...
func spawn_car(spawn_point: Marker2D, car_pool: Array, delay: float, velocity: float, direction: Vector2 = Vector2.LEFT, flip: bool = false):
...
func _on_timer_timeout():
	...
	spawn_car(%CarSpawn3, CAR_TYPES, randf_range(0.05, 0.4), 500, Vector2.RIGHT, true)
	spawn_car(%CarSpawn4, CAR_TYPES, randf_range(0.05, 0.4), 300, Vector2.RIGHT, true)
